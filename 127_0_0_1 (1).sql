...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2025 at 11:25 AM
...
INSERT INTO `invoices` (`invoices_id`, `order_id`, `total_price`, `date`) VALUES
(1, 7, 140, '2021-05-21'),
(2, 8, 20, '2021-05-25'),
(3, 9, 150, '2021-05-27'),
(4, 10, 120, '2021-05-27'),
...
INSERT INTO `orders` (`id`, `product_id`, `user_id`, `quantity`, `date`) VALUES
(7, 5, 3, 1, '2021-05-21'),
(8, 1, 3, 2, '2021-05-25'),
(9, 9, 4, 3, '2021-05-27'),
(10, 8, 5, 3, '2021-05-27'),
(11, 11, 4, 3, '2021-05-30'),
(12, 10, 6, 5, '2021-05-30'),
(13, 7, 5, 7, '2021-05-18');
...
INSERT INTO `products` (`id`, `name`, `category_id`, `price`, `quantity`, `description`) VALUES
(1, 'Gone with the Wind', 2, 10, 68, 'novel by American writer Margaret Mitchell'),
(2, 'The Big Four', 2, 12, 70, 'work of detective fiction by Agatha Christie'),
(3, 'Blue Carbuncle', 2, 10, 50, 'From The Adventures of Sherlock Holmes'),
(4, 'Redmi Note 8 pro', 3, 140, 10, 'smartphone by Redmi'),
(5, 'Galaxy A21s', 3, 140, 29, 'Samsung smart phones'),
(6, 'Galaxy M02', 3, 100, 40, 'phone'),
(7, 'blue flower fresh', 1, 30, 93, 'short dress'),
(8, 'casual white', 1, 40, 147, 'women casual summer dress'),
(9, 'white red ', 1, 50, 17, 'party long dress'),
(10, 'Barbie', 4, 4, 95, 'doll'),
(11, 'star', 4, 10, 197, 'cool yellow remote car');
...
INSERT INTO `users` (`id`, `name`, `email`, `mobile`, `password`, `role`, `country`) VALUES
(1, 'malak', 'malak@gmail.com', '+97059912345', '123456', 'admin', 'palestine'),
(2, 'aya', 'aya@gmail.com', '+97054781263', 'eman12', 'admin', 'jordan'),
(3, 'leen', 'leen@gmail.com', '+97059214589', '123456d', 'client', 'egypt'),
(4, 'layan', 'layan@gmail.com', '+97059214789', '123456', 'client', 'germany'),
(5, 'maria', 'maria@gmail.com', '+97059214787', 'maria', 'client', 'palestine'),
(6, 'asmaa', 'asmaa@gmail.com', '+97059214789', 'naddosh', 'client', 'palestine');
...
--
-- Database: `llm_output_tracking`
--
CREATE DATABASE IF NOT EXISTS `llm_output_tracking` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `llm_output_tracking`;

-- --------------------------------------------------------

--
-- Table structure for table `llm_output`
--

CREATE TABLE `llm_output` (
  `Io_id` int(11) NOT NULL,
  `Io_prompt` varchar(200) NOT NULL,
  `Io_text` varchar(200) NOT NULL,
  `Io_date_created` timestamp NOT NULL DEFAULT current_timestamp(),
  `Io_is_reviewed` tinyint(1) DEFAULT 0 CHECK (`Io_is_reviewed` between 0 and 1),
  `Io_model_name` varchar(50) DEFAULT 'GPT 3.5',
  `Io_user_email` varchar(100) DEFAULT NULL,
  `Io_rating` tinyint(2) DEFAULT 0 CHECK (`Io_rating` between 0 and 10),
  `IO_prompt_category` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `llm_output`
--
ALTER TABLE `llm_output`
  ADD PRIMARY KEY (`Io_id`),
  ADD UNIQUE KEY `Io_user_email` (`Io_user_email`);
...
--
-- AUTO_INCREMENT for table `llm_output`
--
ALTER TABLE `llm_output`
...
('root', '[{\"db\":\"\",\"table\":\"rentals\"},{\"db\":\"rental_shop\",\"table\":\"rentals\"},{\"db\":\"\",\"table\":\"country\"},{\"db\":\"world\",\"table\":\"country\"},{\"db\":\"world\",\"table\":\"countrylanguage\"},{\"db\":\"llm_output_tracking\",\"table\":\"llm_output\"},{\"db\":\"llm_output_tracking\",\"table\":\"llm_output_v2\"},{\"db\":\"\",\"table\":\"llm_output\"},{\"db\":\"shop\",\"table\":\"products\"},{\"db\":\"company\",\"table\":\"users\"}]');
...
('root', 'world', 'city', '{\"CREATE_TIME\":\"2025-05-08 12:31:52\",\"col_order\":[0,1,2,3,4],\"col_visib\":[1,1,1,1,1]}', '2025-05-08 09:32:29'),
('root', 'world', 'country', '{\"sorted_col\":\"`country`.`IndepYear` DESC\"}', '2025-05-22 18:36:45');
...
('root', '2025-05-23 09:24:50', '{\"Console\\/Mode\":\"collapse\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Database: `rental_shop`
--
CREATE DATABASE IF NOT EXISTS `rental_shop` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `rental_shop`;
...
CREATE TABLE `rentals` (
  ...
  `return_date` datetime DEFAULT NULL CHECK (`return_date` >= `rent_date`),
  `daily_rate` int(2) DEFAULT NULL CHECK (`daily_rate` between 0 and 30),
...
INSERT INTO `rentals` (`rental_id`, `customer`, `costume`, `rent_date`, `return_date`, `daily_rate`, `insertion_date`, `update_date`) VALUES
(1, 'ahmed', 'ghoul', '2025-05-23 12:24:52', NULL, 15, '2025-05-23 09:24:52', '2025-05-23 09:24:52'),
(2, 'Amer', 'PUBJ', '2025-05-23 12:24:52', NULL, 29, '2025-05-23 09:24:52', '2025-05-23 09:24:52'),
(3, 'Yahya', 'Fortnite', '2025-05-23 12:24:52', NULL, 24, '2025-05-23 09:24:52', '2025-05-23 09:24:52'),
(4, 'Mohammed', 'Anime', '2025-05-23 12:24:52', NULL, 20, '2025-05-23 09:24:52', '2025-05-23 09:24:52'),
(5, 'Hassan', 'Robot', '2025-05-23 12:24:52', NULL, 30, '2025-05-23 09:24:52', '2025-05-23 09:24:52'),
(6, 'Alaa', 'Monster', '2025-05-23 12:24:52', NULL, 26, '2025-05-23 09:24:52', '2025-05-23 09:24:52'),
(7, 'Waleed', 'Animal', '2025-05-23 12:24:52', NULL, 9, '2025-05-23 09:24:52', '2025-05-23 09:24:52'),
(8, 'Khalid', 'Soldier', '2025-05-23 12:24:52', NULL, 11, '2025-05-23 09:24:52', '2025-05-23 09:24:52');
